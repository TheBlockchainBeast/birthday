          ...
          <div className="layout-content-container flex flex-col max-w-[960px] flex-1">
            ...
            <div className="grid grid-cols-[repeat(auto-fit,minmax(158px,1fr))] gap-3 p-4">
              ...
              <div className="flex flex-col gap-3">
                <div
                  className="w-full bg-center bg-no-repeat aspect-square bg-cover rounded-lg"
                  style={{ backgroundImage: 'url("https://lh3.googleusercontent.com/aida-public/AB6AXuCoaiU_TvIlnLiPiul3Izh2vwRX2iqRLWt2TgWTtF_umarQQXZ-VAI9qshwYAUyMWzZhRhZV3TZxicjkjMTG49L-BAYGBX2IkuAQ54D_d70zUaMH57iEGu_TcaNjh2iwq4k3Z-D33F5wQob2rAiUAFWK252DvNaby9awwbBXFKtYZgvmHmChDqJuR9BB7Ei77oS0QSE5wUk00_XFSFjLICyWCFEMkIt7Zg1jpHukh9ojWRxCipc75q6J3dVw0Vkl__gUDFS6gfVw")' }}
                ></div>
              </div>
            </div>
